...
class NewsTest < ApplicationSystemTestCase
  ...
  test "creating a News" do
    ...
    fill_in "Foto", with: @news.foto
    fill_in "Id Creator", with: @news.id_creator
    fill_in "Isi", with: @news.isi
    fill_in "Judul", with: @news.judul
    fill_in "Ringkasan", with: @news.ringkasan
